            ...
            <div class="col-md-6">
                <div class="dropdown" style="padding: 0px;float: right;margin-right: 15px;min-width: 250px;">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <form name="post_5ddea5e87901f538364548" style="display:none;" method="post" action="#"><input type="hidden" name="_method" class="form-control" value="POST"></form><a href="#" class="text-danger" onclick="bootbox.confirm(&quot;Deseja excluir este certificado?&quot;,
            function (result) {
                if (result) { document.post_5ddea5e87901f538364548.submit(); }                
            }); event.returnValue = false; return false;"><i class="fa fa-trash"></i> Excluir Certificado</a>                        </li>
                        <li>
...
-->
       ...
       <!--Divisória de conteúdo modal-->
       <div id="m0" class="modalAjuda collapse">
<div class="modal-body">
