...
<p class="P3">&nbsp;</p>
<p class="P10">Certificamos que <?php echo $nome_usuario  ?> concluiu <?php echo $nome_atv  ?>, ofertado pelo Instituto Federal de Educação, Ciência e Tecnologia do Ceará, IFCE – Acopiara, em <?php echo $data_inicial_atv  ?>, com carga horária total de <?php echo $carga_horaria_atv  ?>.</p>
<p class="P4">&nbsp;</p>
<p class="P5">
	<span>&nbsp;</span>
	<span>&nbsp;</span>
