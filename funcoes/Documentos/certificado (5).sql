...
--
-- Host: 127.0.0.1
-- Generation Time: 22-Nov-2019 às 20:45
...
--
ALTER TABLE `atividade`
  MODIFY `id_atv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `participa`
  MODIFY `id_participa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
