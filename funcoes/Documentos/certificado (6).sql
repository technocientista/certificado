...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Nov-2019 às 17:51
...
(2, 'Curso de PHP', '2019-11-21', '20h', '2019-12-21', 'Online', 1, 1, 'Curso online de PHP grátis', 4),
(3, 'Curso de HTML', '2019-11-21', '20h', '2019-11-20', 'Online', 1, 1, 'Curso online de HTML grátis', 4),
(4, 'Curso de InglÃªs', '2019-11-22', '40h', '2019-11-22', 'Online', 1, 1, '', 4),
(5, 'Curso de MatemÃ¡tica', '2019-11-22', '40h', '2019-11-22', 'Online', 1, 1, '', 4),
...
--
-- Índices para tabela `msg_suporte`
--
...
--
-- Índices para tabela `responde_msg`
--
...
--
-- Índices para tabela `situacao_ativ`
--
ALTER TABLE `situacao_ativ`
  ADD PRIMARY KEY (`id_situacao_ativ`);

--
-- Índices para tabela `situacao_certif`
--
...
--
ALTER TABLE `atividade`
  MODIFY `id_atv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT de tabela `msg_suporte`
--
ALTER TABLE `msg_suporte`
...
--
ALTER TABLE `participa`
  MODIFY `id_participa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- AUTO_INCREMENT de tabela `situacao_ativ`
--
ALTER TABLE `situacao_ativ`
  MODIFY `id_situacao_ativ` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de tabela `situacao_certif`
--
ALTER TABLE `situacao_certif`
