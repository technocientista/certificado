...
--
-- Host: 127.0.0.1
-- Generation Time: 22-Nov-2019 às 00:49
...
CREATE TABLE atividade (
  ...
  fk_situacao_ativ_id_situacao_ativ int(11) NOT NULL,
...
CREATE TABLE participa (
  ...
  fk_situacao_ativ_id_situacao_ativ int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE atividade
  MODIFY id_atv int(11) NOT NULL AUTO_INCREMENT;
