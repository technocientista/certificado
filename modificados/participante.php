								...
								<table id="tableAcao" class="table table-striped table-hover table-bordered table-condensed">
									...
									<tbody>
										<tr>
											...
											<td class="text-center"><label class="badge badge-primary text-wrap">Matriculado</label></td>
										...
										<tr>
											...
											<td class="tr-max text-center">40h</td>
											<td class="text-center"><label class="badge badge-success text-wrap">Cursando</label></td>
